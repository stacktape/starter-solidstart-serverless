...
> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-solidstart-serverless)

- [SolidStart](https://start.solidjs.com/) app deployed serverlessly via the
  [solidstart-web resource](https://docs.stacktape.com/compute-resources/solidstart-web/) — Lambda + S3 + CloudFront
  CDN.
- Server-side rendered with fine-grained reactivity. Pay only for traffic you serve.
...
```bash
stacktape init --starterId solidstart-serverless
```
